using Pathmaker.Application.Requests.Products;
using Pathmaker.Application.Requests.Products.Commands.CreateProduct;
using Pathmaker.Application.Requests.Products.Commands.UpdateProduct;
